    ...
    "flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed",
    {
        variants: {
            variant: {
                ...
                // ** OUTLINE
                outline:
                    "border border-indigo-400 hover:text-white bg-transparent text-indigo-600 hover:border-transparent hover:bg-indigo-600 dark:text-indigo-600 dark:hover:text-white",
            },
            size: {
                default: "p-3",
